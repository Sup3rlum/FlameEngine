...
EXPORT(class, FOrthonormalBasisMatrix) : public FMatrix4
{
public:
	FOrthonormalBasisMatrix(FVector3 a, FVector3 b)
	{
		...
		FMatrix4((FMatrix4)FBasisMatrix(a, b1, c));
	}
};

FLAME_API FVector3 operator*(const FRotationMatrix& rotation, const FVector3& vec)
{
