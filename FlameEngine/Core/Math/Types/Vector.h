...
typedef TVector4<long long> LVector4;
typedef TVector3<long long> LVector3;
typedef TVector2<long long> LVector2;

typedef TVector4<TCmplx<float>> CVector4;
typedef TVector3<TCmplx<float>> CVector3;
typedef TVector2<TCmplx<float>> CVector2;