...
public:
	...
	virtual void RenderAO(FRITexture2D* depthTex, FRITexture2D* normTex, FRIRenderTargetView* outputFBO, const FMatrix4& projection, const FMatrix4& view) = 0;
