...
void GLHBAOPlus::RenderAO(FRITexture2D* depthTex, FRITexture2D* normTex, FRIRenderTargetView* outputFBO, const FMatrix4& Projection, const FMatrix4& View)
{
	/*
	glBindFramebuffer(GL_FRAMEBUFFER, static_cast<FGLResourceFrameBuffer*>(outputFBO)->frameBufferHandle);
