...
void D3D11HBAOPlus::RenderAO(FRITexture2D* depthTex, FRITexture2D* normTex, FRIRenderTargetView* outputFBO, const FMatrix4& Projection, const FMatrix4& View)
{
	...
	Input.DepthData.pFullResDepthTextureSRV = depthTex->View()->As<FD3D11ShaderResourceView>()->ShaderResourceView.Get();
	...
	Output.pRenderTargetView = outputFBO->As<FD3D11FrameBuffer>()->RenderTargetViews[0].Get();
